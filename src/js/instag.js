	...
	success: function(data){
		console.log("Success.");
			...
			for(y in pic_urls){
				...
				$('ul#kr_instafeed').append('<li><a href="'+pic_links[y]+'"><img src="'+pic_urls[y]+'"><span class="text-content"><span>'+pic_captions[y]+'</span></span></a></li>');
				//var pic_to_show = "li#"+pic_ids[y];
				//console.log(pic_to_show);
				$( 'ul#kr_instafeed' ).animate({'opacity':'1'},{duration: 2500, queue:false});
			}
	},
	error: function(data){
